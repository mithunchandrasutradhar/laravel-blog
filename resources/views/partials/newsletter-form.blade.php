...
<div class="newsletter-form-wrapper" x-data="newsletterForm()" id="newsletter-{{ $variant }}">
    <form @submit.prevent="submit" class="newsletter-form" novalidate>
        @csrf
                ...
                @else
                    <div class="d-flex flex-column flex-sm-row gap-2">
                        ...
                        <button type="submit" class="btn btn-primary px-4 fw-semibold" :disabled="loading">
                            <span x-show="!loading">Subscribe</span>
                            <span x-show="loading"><i class="fas fa-spinner fa-spin me-1"></i>Subscribing...</span>
                        </button>
                    </div>
                @endif
